...
// {
//     // Create ConfigBase
//     RaftModConfig testConfigBase = pSourceStr;
...
//     String jsonRslt = RaftJson::getStringStatic(dataPath, "<<NOT_FOUND>>", pSourceStr);
//     // LOG_I(MODULE_PREFIX, "testGetString dataPath %s expected %s", dataPath, expectedStr);
...
//     long jsonLong = RaftJson::getLongStatic(dataPath, -1, pSourceStr);
//     // LOG_I(MODULE_PREFIX, "testGetString dataPath %s expected %s", dataPath, expectedStr);
//     if (jsonLong != cfgLong)
//     {
...
//     double jsonDouble = RaftJson::getDoubleStatic(dataPath, -1.5, pSourceStr);
//     // LOG_I(MODULE_PREFIX, "testGetString dataPath %s expected %s", dataPath, expectedStr);
