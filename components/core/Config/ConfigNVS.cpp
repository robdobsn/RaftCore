...
// bool ConfigNVS::setNewContent(const String& configJSONStr)
// {
//     // Check length of string
//     if (configJSONStr.length() >= getMaxLen())
//     {
//         LOG_E(MODULE_PREFIX, "setNewContent config too long %d > %d", configJSONStr.length(), getMaxLen());
//         return false;
//     }
...
//     // Debug
//     LOG_W(MODULE_PREFIX, "setNewContent %s config len: %d", 
...
//         {
//             LOG_E(MODULE_PREFIX, "setNewContent Writing Failed %s written = %d", 
