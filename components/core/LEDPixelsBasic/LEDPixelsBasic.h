...
class LEDPixelsBasic
{
public:
    LEDPixelsBasic();
    virtual ~LEDPixelsBasic();
...
private:
    ...
    // LED strip drivers - using BasicRMTLedsWrapper with simple encoder
    std::vector<BasicRMTLedsWrapper> _ledStripDrivers;
    ...
    // Debug
    static constexpr const char* MODULE_PREFIX = "LEDPixBasic";
};
